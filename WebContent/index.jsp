...
<body id="myPage" data-spy="scroll" data-target=".navbar"
	...
	<div class="container-fluid" id="about">
		...
		<p>
		PPC flights record specilaize for PPC. <br>
		Fuel, Oil consamption, Engine hour, Remarks on things to maintain that raize in the flight. <br>
		Pilot, Passenger, Airfield, Description of flight route.
		</p>
		<br>
		<h4>Maintenance Logbook</h4>
		<p>
		PPC maintenance record. <br>
		What, When, Who, Cost ...
		</p>
	...
	<div class="container-fluid bg-grey">
		<h2>Our Values</h2>
		<h4>
			<strong>MISSION:</strong> "One Stop Shop" for all the PPC activity recording. 
		</h4>
		<p>
			<strong>VISION:</strong>  To give the PPC owner\s a packadge for full life cycle of the PPC.
	</div>
